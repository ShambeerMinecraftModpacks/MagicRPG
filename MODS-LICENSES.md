...
| `Automagy-1.7.10-0.28.2.jar` | Automagy | 1.7.10-0.28.2 | не указан | не найден внутри JAR |
| `Avaritia-1.97.jar` | Avaritia | 1.97 | не указан | не найден внутри JAR |
| `Avaritiaddons-1.9.4-GTNH.jar` | Avaritiaddons | 1.9.4-GTNH | http://minecraft.curseforge.com/projects/avaritiaddons | не найден внутри JAR |
| `BaublesExpanded-2.2.21-GTNH.jar` | Baubles Expanded | 2.2.21-GTNH | https://github.com/jss2a98aj/Baubles-Expanded | не найден внутри JAR |
| `bdlib-1.11.0-GTNH.jar` | BD lib | 1.11.0-GTNH | bdew.net/mods/ | не найден внутри JAR |
| `bettercrashes-1.4.5-GTNH.jar` | BetterCrashes | 1.4.5-GTNH | https://github.com/GTNewHorizons/BetterCrashes | не найден внутри JAR |
| `BigReactors-0.4.3A.jar` | Big Reactors | 0.4.3A | http://www.big-reactors.com | не найден внутри JAR |
| `BloodArsenal-1.5.10.jar` | Blood Arsenal | 1.5.10 | https://github.com/GTNewHorizons/BloodArsenal | не найден внутри JAR |
| `BloodMagic-1.9.4.jar` | Blood Magic: Alchemical Wizardry | 1.9.4 | http://www.minecraftforum.net/topic/1899223- | не найден внутри JAR |
| `bogosorter-1.3.28-GTNH.jar` | Inventory Bogo Sorter | 1.3.28-GTNH | не указан | не найден внутри JAR |
| `Bookshelf-1.7.10-1.0.4.187.jar` | Bookshelf | 1.7.10-1.0.4.187 | http://minecraft.curseforge.com/projects/bookshelf | не найден внутри JAR |
...
| `craftingtweaks-mc1.7.10-1.0.79.jar` | Crafting Tweaks | 1.0.79 | не указан | не найден внутри JAR |
| `defaultkeys-1.3.1.jar` | Default Configs | 1.3.1 | https://www.curseforge.com/minecraft/mc-mods/default-options | не найден внутри JAR |
| `DisenchanterMod-[1.7.10]1.6.jar` | Disenchanter | 1.6 | http://minecraft.curseforge.com/projects/the-disenchanter-mod | файл в JAR: LICENSE.txt |
| `Draconic-Evolution-1.5.26-GTNH.jar` | Draconic Evolution | 1.5.26-GTNH | http://www.brandon3055.com/ | не найден внутри JAR |
| `DummyCore-1.21.0.jar` | DummyCore | 1.21.0 | не указан | не найден внутри JAR |
...
| `extrautilities-1.2.12.jar` | Extra Utilities | 1.2.12 | не указан | не найден внутри JAR |
| `Forbidden.Magic-0.9.16-GTNH.jar` | Forbidden Magic | 0.9.16-GTNH | http://www.minecraftforum.net/topic/2305054-/ | не найден внутри JAR |
| `Forestry-4.11.26.jar` | Forestry | 4.11.26 | http://forestry.sengir.net/ | не найден внутри JAR |
...
| `IronBackpacks-1.7.10-1.2.20.jar` | Iron Backpacks | 1.1.2 | не указан | не найден внутри JAR |
| `IronChest-6.1.13.jar` | Iron Chests | 6.1.13 | http://www.minecraftforum.net/topic/981855- | не найден внутри JAR |
| `ironfurnaces-1.2.4R.jar` | Iron Furnaces | 1.2.4 | не указан | не найден внутри JAR |
| `journeymap-1.7.10-5.1.4p3-unlimited.jar` | JourneyMap | 1.7.10-5.1.4p3 | http://journeymap.info | файл в JAR: license.txt |
| `Login_Shield-1.7.10-2-gf6e21a7.jar` | Login Shield | 1.7.10-2-gf6e21a7 | не указан | не найден внутри JAR |
| `magicbees-2.10.9-GTNH.jar` | Magic Bees | 2.10.9-GTNH | http://bit.ly/XFDvLY | не найден внутри JAR |
| `Mantle-0.5.2.jar` | Mantle | 0.5.2 | https://github.com/SlimeKnights/Mantle | не найден внутри JAR |
| `MineTweaker3-1.7.10-3.0.10B.jar` | MineTweaker 3 | 1.7.10-3.0.10 | http://minetweaker3.powerofbytes.com | не найден внутри JAR |
| `modularui2-2.3.67-1.7.10.jar` | Modular UI 2 | 2.3.67-1.7.10 | https://github.com/CleanroomMC/ModularUI/tree/1.7.10 | не найден внутри JAR |
...
| `roguelike-1.6.6-GTNH.jar` | Roguelike Dungeons | 1.6.6-GTNH | github.com/Greymerk/minecraft-roguelike | не найден внутри JAR |
| `salisarcana-1.1.64-GTNH.jar` | Salis Arcana | 1.1.64-GTNH | https://github.com/rndmorris/Salis-Arcana | файл в JAR: COPYING |
| `Sanguimancy-1.7.10-1.1.9-35.jar` | Sanguimancy | 1.7.10-1.1.9-35 | http://www.minecraftforum.net/forums/mapping-and-modding/minecraft-mods/2194354-blood-magic-addon-sanguimancy | не найден внутри JAR |
| `ServerUtilities-2.3.0.jar` | ServerUtilities | 2.3.0 | https://github.com/GTNewHorizons/ServerUtilities | не найден внутри JAR |
| `SmoothFont-1.7.10-1.15.3.jar` | Smooth Font | 1.7.10-1.15.3 | https://minecraft.curseforge.com/projects/smooth-font | не найден внутри JAR |
...
| `ThaumicTinkerer-2.12.22.jar` | Thaumic Tinkerer | 2.12.22 | minecraftforum.net/topic/1813058- | не найден внутри JAR |
| `ThermalDynamics-[1.7.10]1.2.1-172.jar` | Thermal Dynamics | 1.2.1 | http://www.teamcofh.com | не найден внутри JAR |
| `ThermalExpansion-[1.7.10]4.1.5-248.jar` | Thermal Expansion | 4.1.5 | http://www.teamcofh.com | не найден внутри JAR |
| `ThermalFoundation-[1.7.10]1.2.6-118.jar` | Thermal Foundation | 1.2.6 | http://www.teamcofh.com | не найден внутри JAR |
| `TiCTooltips-1.4.1.jar` | TiC Tooltips | 1.4.1 | http://www.minecraftforum.net/topic/2509840- | не найден внутри JAR |
| `TravellersGear-1.7.10-1.16.6.jar` | Traveller's Gear | 1.16.6 | http://minecraft.curseforge.com/mc-mods/224440-travellers-gear | не найден внутри JAR |
| `TwilightForest-2.7.33.jar` | The Twilight Forest | 2.7.33 | http://www.minecraftforum.net/topic/561673- | не найден внутри JAR |
| `txloader-1.8.11.jar` | TX Loader | 1.8.11 | https://github.com/glowredman/TX-Loader | не найден внутри JAR |
| `WanionLib-1.7.10-1.8.jar` | WanionLib | 1.7.10-1.8 | http://minecraft.curseforge.com/projects/wanionlib | не найден внутри JAR |
| `WarpTheory-1.5.7-GTNH.jar` | WarpTheory | 1.5.7-GTNH | не указан | не найден внутри JAR |
| `wdmla-2.8.1.jar` | Waila | 2.8.1 | не указан | не найден внутри JAR |
| `WirelessCraftingTerminal-1.12.16.jar` | AE2 Wireless Crafting Terminal | 1.12.16 | http://p455w0rd.net/ | не найден внутри JAR |
| `Witchery.jar` | Witchery | 1.7.10-0.24.1 | http://sites.google.com/site/witcherymod/ | не найден внутри JAR |
| `WitcheryExtras-1.4.15.jar` | Witchery++ | 1.4.15 | https://github.com/GTNewHorizons/WitcheryExtras | не найден внутри JAR |
| `WitcheryPatch-1.7.10-1.0.0.jar` | WitcheryPatch-1.7.10-1.0.0 | не указана | не указан | не найден внутри JAR |
| `WitchingGadgets-1.8.45-GTNH.jar` | Witching Gadgets | 1.8.45-GTNH | не указан | не найден внутри JAR |
